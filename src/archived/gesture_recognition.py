...
while(cap.isOpened()):
    ...
    # if count_defects == 1:
    #     cv2.putText(img, "This means that we could detect 1 finger",
    #                 (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0))
    # elif count_defects == 2:
    #     str = "This means that we could detect 2 fingers"
    #     cv2.putText(img, str, (50, 50), cv2.FONT_HERSHEY_SIMPLEX,
    #                 2, (255, 0, 0))
    # elif count_defects == 3:
    #     cv2.putText(img, "This means that we could detect 3 fingers",
    #                 (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0))
    # elif count_defects == 4:
    #     cv2.putText(img, "This means that we could detect 4 fingers",
    #                 (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0))
    # else:
