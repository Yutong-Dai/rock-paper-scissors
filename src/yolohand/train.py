...
Usage:
    $ python3 train.py --data hand.yaml --weights yolov5n.pt --img 640
"""
import argparse
import math
import os
...
def parse_opt(known=False):
    ...
    parser.add_argument('--single-cls', action='store_false', default=True, help='train multi-class data as single-class')
