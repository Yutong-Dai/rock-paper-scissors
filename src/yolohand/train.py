...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT /
                        'models/yolov5n.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT /
                        'data/hand.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT /
                        'data/hyps/hyp.finetune.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--single-cls', action='store_false',
                        default=True, help='train multi-class data as single-class')
